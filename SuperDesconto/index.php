...
<body>
    ...
    <div class="container-commodities">
        <a href="profile.php" class="a-card">
            <button class="button-card">
                <div class="card card-commodities">
                    <div class="card-img">
                        <img src="imagens/cocacola-350ml.png" width="160px" height="160px">
                    </div>
                    <div class="card-info">
                        <p class="text-title">Refrigerante lata Coca-Cola 350ml</p>
                        <p class="text-body">Não contém glútem</p>
                    </div>
                    <div class="card-footer">
                        <span class="text-title">R$ 3.99</span>
